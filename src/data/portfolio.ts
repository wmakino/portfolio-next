...
export const skillGroups: SkillGroup[] = [
  {
    ...
    description: "Training and shipping models, from tabular baselines to LLM-backed apps.",
    items: [
      "Python",
      "NLP",
      "Computer Vision",
  ...
  },
  {
    ...
    description: "Web apps, APIs, and the cloud pieces that host them.",
    items: [
      "FastAPI",
      "Flask",
      "Next.js",
  ...
  {
    title: "AI Management & Operations",
    description: "MLflow, drift reports, and the governance work after a model ships.",
    items: [
      "MLOps",
      "Model Monitoring",
      "Data Drift",
